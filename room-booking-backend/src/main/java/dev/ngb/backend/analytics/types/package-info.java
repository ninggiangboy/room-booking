/**
 * Enums used by another module that already depends on {@code analytics} in every other respect — the R3
 ...
 * dependency direction. See {@code docs/modules/analytics.md} for which enum lives here and why.
 */
