/**
 * Enums used by another module that already depends on {@code supply} in every other respect — the R3
 ...
 * dependency direction. See {@code docs/modules/supply.md} for which enum lives here and why.
 */
@org.springframework.modulith.NamedInterface("types")
@org.jspecify.annotations.NullMarked
package dev.ngb.backend.supply.types;
