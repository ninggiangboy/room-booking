/**
 * Enums used by another module that already depends on {@code pricing} in every other respect — the R3
 ...
 * dependency direction. See {@code docs/modules/pricing.md} for which enum lives here and why.
 */
