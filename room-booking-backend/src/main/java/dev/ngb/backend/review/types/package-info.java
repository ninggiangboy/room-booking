/**
 * Enums used by another module that already depends on {@code review} in every other respect — the R3
 ...
 * dependency direction. See {@code docs/modules/review.md} for which enum lives here and why.
 */
