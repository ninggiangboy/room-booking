package dev.ngb.backend.market.internal.repository.market;

import org.springframework.data.repository.ListCrudRepository;
import java.util.List;
import java.util.UUID;

import dev.ngb.backend.market.internal.model.market.ApprovalSubjectType;
import dev.ngb.backend.market.internal.model.market.MarketApprovalRecord;
